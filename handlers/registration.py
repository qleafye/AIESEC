...
START_TEXT = (
    "Привет!\n"
    "Это бот форума SkillUp — пространства про карьеру, нетворк и личное развитие.\n\n"
    "Мы выросли из IT-ивента в более широкий формат: здесь про коммуникации, HR-подходы и уверенность в себе на работе.\n\n"
    "<b>Что тебя ждёт на SkillUp?</b>\n"
    "◼️ Практические сессии по резюме: разбор структуры, O2O-прожарки и сценический формат стресс-собеседования;\n"
    "◼️ Блоки по рабочим коммуникациям и теме личных границ в команде;\n"
    "◼️ Сильный акцент на нетворкинг и развитие себя как личности — от первой до финальной сессии;\n"
    "◼️ Живое общение со спикерами в течение всего дня и активности, где каждый включится в диалог.\n\n"
